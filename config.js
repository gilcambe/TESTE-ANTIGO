...
function renderSite() {
  ...
  <section id="hero">
    <div class="hero-vid">
      <iframe src="https://www.youtube.com/embed/${S.heroVideoId}?autoplay=1&mute=1&loop=1&playlist=${S.heroVideoId}&controls=0&showinfo=0&rel=0&modestbranding=1&iv_load_policy=3"
              title="CES 2026" allow="autoplay;encrypted-media" allowfullscreen></iframe>
    </div>
